...
# Set your bot's command prefix here
intents = discord.Intents.default()
intents.message_content = True  # Required for message content access

client = commands.Bot(command_prefix="!", intents=intents) #You can change prefix to whatever you want

@client.event
async def on_ready():
    print(f"Bot is ready. Logged in as {client.user} (ID: {client.user.id})") #Login
